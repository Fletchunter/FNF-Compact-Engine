...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (Paths.formatToSongPath(SONG.song))
		{
			...
			case 'senpai' | 'roses':
				...
				if (Paths.formatToSongPath(SONG.song) == 'roses')
				{
					bgGirls.getScared();
				}
		...
		if(PlayerPrefs.censorNaughty) health = 0.000000001;
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		if (Paths.formatToSongPath(SONG.song) == 'roses' || Paths.formatToSongPath(SONG.song) == 'thorns')
		{
			remove(black);
	...
	function endSong():Void
	{
		...
		if (isStoryMode)
		{
			...
			else
			{
				...
				if (Paths.formatToSongPath(SONG.song) == 'eggnog')
				{
